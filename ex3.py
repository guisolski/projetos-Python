...
# Os metodos gcd e multiplicative_inverse servem para o calculo
# dos parametros 'e' e 'd'
...
# O metodo is_prime pode ser util para se testar se um numero e primo
'''
...
print( "Sua mensagem encripitada é: ")
